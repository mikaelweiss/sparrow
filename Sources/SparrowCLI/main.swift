...
struct Run: ParsableCommand {
    static let configuration = CommandConfiguration(abstract: "Start the development server")
...
struct Build: ParsableCommand {
    static let configuration = CommandConfiguration(abstract: "Build for production")
...
struct New: ParsableCommand {
    static let configuration = CommandConfiguration(abstract: "Create a new Sparrow project")
...
func discoverExecutable(in directory: String) -> String? {
